function AboutSection() {
  return (
    <section className='flex items-center justify-center bg-white py-12 text-center'>
      <div className='flex w-full max-w-6xl flex-col items-center justify-center gap-8 px-4 md:flex-row'>
        {/* Heading */}
        <div className='flex w-[60%] items-center justify-center text-left md:w-4/5 md:justify-center'>
        ...
        {/* Content */}
        <div className='w-[40%] text-left md:w-4/5'>
